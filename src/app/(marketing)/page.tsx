...
export const metadata: Metadata = {
  ...
  description: "Mobile notary services in Port St. Lucie and surrounding Treasure Coast communities. Request service online and receive follow-up to confirm availability and appointment details.",
};
...
const benefits = [
  "Mobile service at an agreed meeting location",
  "Local service throughout the surrounding communities",
  "Clear request and appointment follow-up",
  "Professional, straightforward notary service",
];
  ...
  return <>
    ...
    <main id="main-content"><span id="home" className="anchor-target" />
      <section className="hero" aria-labelledby="hero-title">
        ...
        <div className="shell trust-row" aria-label="Service highlights"><div><ShieldIcon /><span><strong>Mobile Service</strong>At an agreed meeting location</span></div><div><MapPinIcon /><span><strong>Local Service Area</strong>See the communities served</span></div><div><ClockIcon /><span><strong>Scheduling Requests</strong>Availability confirmed separately</span></div></div>
      </section>

      <section className="section services" id="services" aria-labelledby="services-title"><div className="shell">
        <div className="section-heading split-heading"><div><p className="kicker">Notary services</p><h2 id="services-title">Common Notary Requests</h2></div><p>Customers commonly request notarial services for the document types below. Mobile service may be requested at an agreed location. Requirements vary by document and notarial act.</p></div>
      ...
      <section className="section why-section" id="about" aria-labelledby="why-title"><div className="shell why-grid">
        <div className="benefits"><p className="kicker">About 772 Notary</p><h2 id="why-title">Professional. Convenient. Local.</h2><p className="about-copy">772 Notary provides mobile notarial services for individuals and businesses at agreed meeting locations throughout the local service area.</p><ul>{benefits.map((benefit) => <li key={benefit}><span><CheckIcon /></span>{benefit}</li>)}</ul></div>
        <div className="area-card" aria-labelledby="area-title"><div className="area-title"><MapPinIcon /><div><h2 id="area-title">Service Area</h2><p>Mobile service in local communities</p></div></div><p className="area-intro">Mobile appointments may be requested in the communities below. Final availability and meeting details are confirmed separately.</p><ul>{communities.map((community) => <li className={community === "Surrounding communities" ? "community-wide" : undefined} key={community}><CheckIcon />{community}</li>)}</ul><p className="area-script" aria-hidden="true">Mobile service<br />by appointment</p></div>
      </div></section>

      <section className="how-section" id="how-it-works" aria-labelledby="how-title"><div className="shell"><p className="kicker">How it works</p><h2 id="how-title">Requesting Notary Service</h2><div className="step-grid"><article><span>1</span><h3>Tell us what you need</h3><p>Share the document type and number of documents involved without including document contents.</p></article><article><span>2</span><h3>Choose a place and time</h3><p>Enter your proposed meeting location and select your preferred date and time of day.</p></article><article><span>3</span><h3>Review and submit</h3><p>Check your request and contact information, then send it to 772 Notary.</p></article><article><span>4</span><h3>Receive follow-up</h3><p>772 Notary reviews availability and follows up. A submitted request is not a confirmed appointment.</p></article></div></div></section>
      ...
      <section className="cta-wrap" id="contact" aria-labelledby="cta-title"><div className="shell cta-band"><CalendarIcon /><div><h2 id="cta-title">Need a Notary? Let&apos;s Get It Scheduled.</h2><p>Start your request online, or contact 772 Notary directly for assistance.</p></div><Link className="button button-gold" href="/request">Request a Notary <ArrowRightIcon /></Link></div><div className="shell contact-strip"><a href="tel:+17728004555"><span>Call</span>(772) 800-4555</a><a href="mailto:info@772notary.com"><span>Email</span>info@772notary.com</a></div></section>
    </main>

    <footer className="site-footer"><div className="shell footer-main"><a className="brand-link" href="#home" aria-label="772 Notary home"><Brand /></a><Navigation footer /><div className="footer-contact"><a href="tel:+17728004555">(772) 800-4555</a><a href="mailto:info@772notary.com">info@772notary.com</a></div></div><div className="shell footer-bottom"><p>© {new Date().getFullYear()} 772 Notary LLC. All rights reserved.</p><p>Mobile notary service across Florida&apos;s Treasure Coast.</p></div></footer>
  </>;
}
